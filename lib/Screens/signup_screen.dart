...
import 'package:storarch/login_screen.dart';
// Optional: If you want to use a Google icon for the button
// import 'package:font_awesome_flutter/font_awesome_flutter.dart';

// TODO: Potentially import your Login Screen file here later for navigation
...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    const Color accentBeige = Color(0xFFD2B48C); // Beige for primary button and borders
    ...
    InputDecoration inputDecoration(String label) {
      return InputDecoration(
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(10.0),
          borderSide: const BorderSide(color: Colors.white, width: 2.0), // Highlight focus
        ),
        filled: true, // Need filled = true to show fillColor
        fillColor: fillColor.withOpacity(0.05), // Match input background to main background
      );
    }
    ...
    return Scaffold(
      ...
      body: SafeArea( // Avoid overlap with status bar/notches
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                // --- Create Account Button ---
                 ElevatedButton(
                   onPressed: () {
                     // TODO: Implement Email/Password Account Creation Logic
                     // TODO: Add validation (fields not empty, passwords match, email format)
                     print('Email: ${_emailController.text}');
                     print('Name: ${_nameController.text}');
                     print('Password: ${_passwordController.text}');
                     print('Confirm Password: ${_confirmPasswordController.text}');
                     if (_passwordController.text != _confirmPasswordController.text) {
                       // Basic validation example - show a snackbar or dialog
                      ...
                      print('Validation Passed - Proceeding with account creation...');
                      /// Navigate to HomePage after account creation
Navigator.pushReplacement(
  context,
  MaterialPageRoute(builder: (context) => HomePage(onToggleTheme: () {  },)),
);
                   },
                   style: ElevatedButton.styleFrom(
                     backgroundColor: buttonColor, // Beige background
                     padding: const EdgeInsets.symmetric(vertical: 15, horizontal: 100), // Make button taller
                     shape: RoundedRectangleBorder(
                       borderRadius: BorderRadius.circular(30.0), // More rounded ends
                     ),
                     elevation: 5,
                   ),
                   child: const Text(
                      ...
                      children: <TextSpan>[
                        TextSpan(
                          ...
                          style: const TextStyle(
                            ...
                            fontWeight: FontWeight.bold,
                            decoration: TextDecoration.underline, // Add underline like the image
                             fontSize: 14
                          ),
